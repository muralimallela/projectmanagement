...
public class StudentReviewDAO {
	...
	private static final String STUDENT_REVIEW_SEARCH = "SELECT"+" s.studentID,s.firstname,s.lastname,s.batchyear,pr.projecttitle,pr.description,f.firstname,f.lastname"+
			" FROM participants pt"+
			" JOIN students s ON s.studentID = pt.studentID"+
